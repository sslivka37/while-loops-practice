...
public class WhileLoopsPractice {
	    ...
	    public static void main(String [] args) {
	       ...
	       //while loop
	        ...
	        //ask for a number, then count to that number in evens starting from zero, and output the number of iterations
	        System.out.println("Enter a number");
	        ...
	        //so we have an option for an even or odd number here, so we have to make conditions for outputs based on %2
	        ...
	        //ask user for PIN, if they get it wrong give error and try again, if correct display message, give three attempts to shut down
